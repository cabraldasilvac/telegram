<?php
 // include 'token.php';
	$botToken = "488011316:AAGv2EbQdvYdb28A-EzIy5WhqZkjSgX6Y7g";
  ...
  if($querydata == "ModificaMessaggio"){
   ...
   $esempiotastierainline = '[{"text":"Testo","url":"http://arcadoconcerto.com"},{"text":"Inline","switch_inline_query":"Ciao!"}],[{"text":"Testo","callback_data":"StampaMessaggio"},{"text":"Modifica Messaggio","callback_data":"ModificaMessaggio"}]';
